      ...
      <div className="bg-white flex flex-col rounded-xl p-6 border items-center w-full h-full">
        ...
        <div className="flex flex-col items-center gap-2">
          <p className="text-lg font-bold">
            Username: <span className="font-light">{profileData.username}</span>
          </p>
          <p className="text-lg font-bold">
          ...
          <p className="text-lg font-bold">
            Head quarter:{" "}
            <span className="font-light">{profileData.headquarter}</span>
          </p>
          <p className="text-lg font-bold">
            Fiscal code:{" "}
            <span className="font-light">{profileData.fiscalCode}</span>
          </p>
          <p className="text-lg font-bold">
            Vat number:{" "}
            <span className="font-light">{profileData.vatNumber}</span>
          </p>
          <p className="text-lg font-bold">
            Your vision: <span className="font-light">{profileData.bio}</span>
          </p>
        </div>
        <button
          ...
          <div className="bg-white rounded-lg p-6 max-w-md w-full max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex justify-end gap-2 pt-4">
                ...
                <button
                  type="submit"
                  className="px-4 py-2  rounded-lg text-white bg-[#2c2c2c] hover:bg-[#1e1e1e] transition-colors"
                >
                  Save Changes
                </button>
              </div>
