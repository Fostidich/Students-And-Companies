    ...
    <div>
      ...
      <div className="bg-white flex flex-col rounded-xl p-6 border items-center">
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          <p className="text-lg font-bold">
            Surname: <span className="font-light">{surname}</span>
          </p>
          <p className="text-lg font-bold">
            University: <span className="font-light">{university}</span>
          </p>
          <p className="text-lg font-bold">
            Course of study: <span className="font-light">{courseOfStudy}</span>
          </p>
          <p className="text-lg font-bold">
            Birthdate: <span className="font-light">{birthDate}</span>
          </p>
          <p className="text-lg font-bold">
            Your bio: <span className="font-light">{bio}</span>
          </p>
        </div>
        <button
