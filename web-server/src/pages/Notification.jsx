...
function Notification() {
    ...
    const handleNotificationDelete = (notificationId) => {
        setNotification(prev => prev.filter(not => not.studentNotificationId !== notificationId));
    };
    ...
    if (notification.length === 0) {
        return <div className="p-8 flex flex-col items-center justify-center">No notifications available</div>;
    }
