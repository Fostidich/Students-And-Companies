...
\subsubsection{POST api/register/user}
\begin{itemize}
    \item Request body - \verb|{user: RegistrationForm}|
    \item Response 201 - Created
    \item Response 401 - Validation Error \verb|{error: Error}|
\end{itemize}

\subsubsection{POST api/login/user}
\begin{itemize}
...
\subsubsection{POST api/user/\{userID\}/upload/cv}
\begin{itemize}
...
\subsubsection{POST api/user/\{userID\}/create/advertisement}
\begin{itemize}
...
\subsubsection{GET api/user/\{userID\}/retrieve/advertisements}
\begin{itemize}
...
\subsubsection{GET api/user/\{userID\}/retrieve/candidates}
\begin{itemize}
...
\subsubsection{POST api/user/\{userID\}/create/questionnaire}
\begin{itemize}
...
\subsubsection{GET api/user/\{userID\}/retrieve/questionnaire/\{questionnaireID\}}
\begin{itemize}
...
\subsubsection{POST api/user/\{userID\}/fill/questionnaire/\{questionnaireID\}}
\begin{itemize}
    \item Request body - \verb|{questionnaire: Questionnaire}|
    \item Response 201 - Created
    \item Response 400 - Validation Error \verb|{error: Error}|
...
\subsubsection{POST api/user/\{userID\}/accept/enrollment/\{enrollmentID\}}
\begin{itemize}
    \item Response 200 - OK
    \item Response 400 - Validation Error \verb|{error: Error}|
    \item Response 401 - Unauthorized \verb|{error: Error}|
...
\subsubsection{GET api/user/\{userID\}/retrieve/internship/\{internshipID\}}
\begin{itemize}
...
\subsubsection{POST api/user/\{userID\}/create/complaint}
\begin{itemize}
...
\subsubsection{GET api/user/\{userID\}/retrieve/complaints}
\begin{itemize}
...
\subsubsection{POST api/user/\{userID\}/interrupt/internship/\{internshipID\}}
\begin{itemize}
    \item Response 200 - OK
    \item Response 400 - Validation Error \verb|{error: Error}|
    \item Response 401 - Unauthorized \verb|{error: Error}|
...
\subsubsection{POST api/user/\{userID\}/feedback/internship/\{internshipID\}}
\begin{itemize}
...
\subsubsection{GET api/user/\{userID\}/retrieve/notifications}
\begin{itemize}
...
\begin{itemize}
    \item \verb|User login(username: String, password: String)|
    \item \verb|bool register(info: UserInfo)|
\end{itemize}
