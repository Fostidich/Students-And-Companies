...
\subsubsection{POST api/login/user/\{user\}}
\begin{itemize}
    \item Request parameters - \verb|{user: User}|
    \item Response 200 - \verb|{username: String, token: String}|
    \item Response 400 - \verb|{validationError: Error}|
    \item Response 401 - \verb|{loginError: Error}|
\end{itemize}
